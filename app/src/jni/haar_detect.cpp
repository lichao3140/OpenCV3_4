...
extern"C" {
    ...
    JNIEXPORT void JNICALL Java_com_lichao_opencv3_4_CameraViewActivity_initLoad(JNIEnv* env, jobject, jstring haarFilePath) {
    ...
    JNIEXPORT void JNICALL Java_com_lichao_opencv3_4_CameraViewActivity_faceDetect(JNIEnv* env, jobject, jlong address) {
        int flag = 1000;
